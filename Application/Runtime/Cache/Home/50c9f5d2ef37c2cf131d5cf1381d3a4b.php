        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav navbar-right" style="margin-left: 0">
                    ...
                    <li><a href="<?php echo U('Register/register');?>"><span class="glyphicon glyphicon-log-in"></span> 注册</a></li>
                </ul>
            </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="3500">
    ...
    <!--</a>-->
    <div id="test">
        <h4 id="welcome">欢迎来到WX云!</h4><br/><br/>
        <form class="bs-example bs-example-form" role="form" method="post" action="/mywebsite_demo/index.php/Home/Login/userlogin">
            <div class="input-group">
                <span class="input-group-addon">
                <span class="glyphicon glyphicon-user"></span>
                     账号</span>
                <input type="text" name="cellphone" class="form-control" placeholder="请填写您的手机号">
            </div>
            <br/>
            <div class="input-group">
                <span class="input-group-addon">
            ...
            <div class="input-group">
                ...
                <img id="verifyimg" src="<?php echo U('Home/Login/creatVerify');?>" width="30%" class="left15" height="50" alt="验证码" title="点击刷新">
            </div>
            <br/>
        <input type="submit" id="login" class="btn btn-primary col-md-12" value="登 录">
        <br/>

        </form>
        <div id="loginfooter">
            <a href="<?php echo U('Login/forgetpw');?>"> 忘记密码？</a><br/>
            <a href="<?php echo U('Register/register');?>">还没有账号？—>注册新账号 </a>
        </div>
