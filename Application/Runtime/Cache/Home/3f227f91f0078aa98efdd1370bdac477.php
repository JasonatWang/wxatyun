            ...
            <ul class="nav navbar-nav ">
               ...
               <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                     <span class="glyphicon glyphicon-cloud"></span>  云盘 <b class="caret"></b>
                  </a>
...
<div id="sidebar" class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
   ...
   <button name="sortitem" value="application" type="submit" class="list-group-item "><span class="glyphicon glyphicon-folder-close"></span> 应用</button>
   <button name="sortitem" value="image" type="submit" class="list-group-item "><span class="glyphicon glyphicon-picture"></span> 图片</button>
   <button name="sortitem" value="secure" type="submit" class="list-group-item "><span class="glyphicon glyphicon-lock"></span> 保险箱</button>
   <button name="sortitem" value="trash" type="submit" class="list-group-item "><span class="glyphicon glyphicon-trash"></span> 回收站</button>
   <button name="sortitem" value="roomleft" type="submit" class="list-group-item ">
            <span class="glyphicon glyphicon-tasks">
                </span>
      <?php $User=A('Index'); $User->hello(); ?>
      剩余空间
   </button>
   </form>
</div>
...
<div class="filelist col-lg-10 col-md-10 col-sm-10 col-xs-10">
    ...
    <div class="row">
        ...
        <a href="#" class="list-group-item" id="filefolder" style="background-color: #2b669a">
            ...
            <?php
 $filename=A('Index'); $filename->showDirname(); ?>
        </a>
            <?php
